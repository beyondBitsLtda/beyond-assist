/* =============================================================================
   ...
   -----------------------------------------------------------------------------
   PARA QUE SERVE
     O docgen deduziu 24 tabela(s) a partir do codigo-fonte.
   ...
   UMA EXECUCAO SO, UM CSV SO - RODE EM QUALQUER BASE
     ...
     Bases que este script vai ler:
       - FLUIG   (12 tabela(s) atribuidas a esta base pelo codigo)
       - CORPORE   (12 tabela(s) atribuidas a esta base pelo codigo)
