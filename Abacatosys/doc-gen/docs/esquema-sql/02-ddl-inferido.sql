/* =============================================================================
   aplicacao - DDL INFERIDO (RASCUNHO, NAO AUTORITATIVO)
...
-- Nenhuma tabela propria ficou apenas inferida: o esquema ja esta declarado
-- (ou nenhuma tabela propria foi identificada no codigo).