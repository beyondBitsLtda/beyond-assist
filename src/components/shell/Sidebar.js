  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: 12, padding: "16px 18px", borderBottom: "1px solid rgba(var(--accent-rgb),0.12)" }}>
        ...
        <div>
          <div style={{ fontSize: 15, fontWeight: 700, letterSpacing: 3, color: "#eafcff", lineHeight: 1 }}>LISA</div>
          <div style={{ ...mono, fontSize: 8, letterSpacing: 2, color: "rgba(var(--accent-rgb),0.6)", marginTop: 3 }}>ASSISTANT</div>
        </div>
      </div>
